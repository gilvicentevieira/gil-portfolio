...
const about = {
  ...
  info: [
    ...
    { fieldName: "Skype", fieldvalue: "gilvicentevieira" },
...
const education = {
  ...
  description: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dignissimos repellat ipsum deleniti, culpa nihil maiores? Error, totam.',
  items: [
    { institution: "Online Course Platform", position: "Full Stack Web Development Bootcamp", duration: "2023" },
    { institution: "Codeacademy", position: "Front-end Track", duration: "2022" },
    { institution: "Online Course Platform", position: "Programming Course", duration: "2020-2021" },
    { institution: "Tech Institute", position: "Certified Web Developer", duration: "2019" },
    { institution: "Designer School", position: "Diploma in Graphic Design", duration: "2016-2018" }
  ]
}
